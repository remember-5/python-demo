...
class Config(object):
    ...
    def __init__(self, config_filepath="config.conf"):
        """
        初始化
        :param config_filepath: config的绝对路径
        """
        self.cf = configparser.ConfigParser()
        self.cf.read(config_filepath)
...
class MyPymysqlPool(BasePymysqlPool):
    ...
    def __init__(self, conf_name=None, conf_path=None):
